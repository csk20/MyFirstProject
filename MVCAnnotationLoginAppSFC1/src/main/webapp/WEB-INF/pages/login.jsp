...
<form:form  class="form-group" commandName="userCmd"  method="post" >

<label for="userid">UserId :</label>
 <form:input   path="user" class="form-control" id="userid" placeholder="Enter Name"  /><form:errors path="user"/><br>
  
  
 
  <label for="pid">Password :</label>
<form:password path="pwd" class="form-control" id="pid"  placeholder="Enter Password"/><form:errors path="pwd"/><br>
